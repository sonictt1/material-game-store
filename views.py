...
import stripe
# Below secrets.py file is not provided, you must make this yourself.
# Put your secret and publishable Stripe keys in that file.
# secrets.py is in the .gitignore file so you won't accidentally commit it.
from secrets import *
...
def checkout_page(request, game_id):
    ...
    if has_key:
        ...
        # Set this in a file called secrets.py. secrets.py is in the .gitignore so you won't accidentally commit it to a db.
        stripe.api_key = TEST_KEY_SECRET
        ...
        try:
            ...
            # this email in your secrets.py file as well.
            #
            ...
            email_succeeded = send_mail('Your game key', 'You ordered ' + game.name + ' for ' + drm + '. Your key is: ' + key.key_text,
                                        'email@example.com', [email], fail_silently=True)
    ...
    context = {
        ...
        'code': code,
        'list': add_to_list,
        'stripe_key': TEST_KEY_PUBLISHABLE,
        # Uncomment the below and comment the above lines if you want to go live.
        # 'stripe_key': PRO_KEY_PUBLISHABLE,
    }
    return HttpResponse(template.render(context, request))
